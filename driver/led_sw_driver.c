...
static int gpio_buzzer     = 26;  /* Physical Pin 37 (Buzzer - Simple GPIO High/Low) */
...
MODULE_PARM_DESC(gpio_buzzer, "GPIO pin for Buzzer (default: 26)");
...
/* ---------------------------------------------------------------------------
 *  수동 부저(Passive Buzzer) 하드웨어 PWM 제어
 * ------------------------------------------------------------------------- */
/* ---------------------------------------------------------------------------
 *  하드웨어 제어 유틸리티
 * ------------------------------------------------------------------------- */
